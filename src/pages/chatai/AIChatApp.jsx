      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-8">
        <div className="max-w-4xl w-full">
          ...
          <div className="absolute top-8 left-8 flex gap-4 z-20">
            <button
              onClick={() => navigate('/')}
              className="bg-white/10 backdrop-blur-md p-3 rounded-full hover:bg-white/20 transition-all text-white border border-white/20"
              title="Go Home"
            >
              <Home size={24} />
            </button>
...
const ChatPage = ({
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className={`${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border-b px-6 py-4 flex items-center justify-between`}
      >
        <div className="flex items-center gap-3">
          <button
            onClick={onBackToLanding}
            className={`${isDarkMode ? "hover:bg-gray-700" : "hover:bg-gray-100"} p-2 rounded-full transition-colors`}
          >
            <ChevronLeft
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title="Settings"
          >
            <Settings className={isDarkMode ? "text-gray-300" : "text-gray-700"} size={20} />
          </button>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-6 mb-24">
        {messages.map((message) => (
          ...
          >
            ...
            >
              <div
                className={`max-w-md px-5 py-3 rounded-2xl ${message.sender === "user"
      ...
      {/* Input Area */}
      <div
        className={`fixed bottom-0 left-0 right-0 ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"
          } border-t px-6 py-4`}
      >
        <div className="max-w-5xl mx-auto flex items-center gap-3">
          <input
            ...
            className={`flex-1 px-6 py-3 rounded-full ${isDarkMode
