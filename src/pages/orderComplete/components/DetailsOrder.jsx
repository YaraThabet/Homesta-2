...
const DetailsOrder = () => {
    const products = [
        ...
        },
        {
            ...
            color: "Brown",
            price: 60.00,
            image: "https://placehold.co/100x100?text=Stool"
        },
         {
            id: 4,
            ...
            color: "Brown",
            price: 180.00,
            image: "https://placehold.co/100x100?text=Bean+Bag"
        }
    ];
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 mb-16 shadow-[0px_2px_4px_rgba(0,0,0,0.02)]">
            ...
            <div className="mt-8 space-y-4 pt-6 border-t border-gray-100 font-[Outfit]">
                 ...
                 <div className="flex justify-between items-center">
                     ...
                     <span className="text-gray-900 text-red-500 font-semibold">-$100.00</span>
                 </div>
