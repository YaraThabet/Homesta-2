...
const DetailsOrder = () => {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-8 mb-16 shadow-[0px_2px_4px_rgba(0,0,0,0.02)]">
      <h2 className="text-2xl font-medium text-gray-900 mb-8 font-[Outfit]">
        Order Details
      </h2>
      ...
      <div className="space-y-8">
        {products.map((product) => (
          <div
            key={product.id}
            className="flex items-center justify-between border-b border-gray-100 pb-8 last:border-0 last:pb-0"
          >
