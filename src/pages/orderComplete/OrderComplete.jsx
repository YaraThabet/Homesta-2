        ...
        <div className="bg-white min-h-screen font-[Outfit] mt-40">
            ...
            <header className="bg-[#F6F6F6] py-12 mb-12">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-3xl font-semibold text-gray-900 mb-2">Order Completed</h1>
            ...
            <div className="container mx-auto px-4 max-w-[1140px]">
                ...
                <div className="text-center mb-16">
                     ...
                     <h2 className="text-3xl font-semibold text-gray-900 mb-3">Your order is completed!</h2>
                     <p className="text-gray-500 font-normal">Thank you. Your Order has been received.</p>
                </div>
                ...
                <div className="bg-[#F0F2F5] rounded-2xl p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
                     <div className="grid grid-cols-2 md:grid-cols-4 gap-y-6 gap-x-12 w-full md:w-auto flex-1">
                         ...
                         <div>
                             <p className="text-gray-400 text-sm mb-1">Estimated Delivery Date</p>
