...
export default function Form() {
  ...
  return (
    <section className="flex flex-col justify-center max-w-lg mx-auto px-4 py-8">
      {/* Logo */}
      <div className="flex items-center gap-2 mb-12">
        <img src="/img/logo.jpg" alt="Homesta Logo" className="w-10 h-10 object-contain rounded-lg" />
