        ...
        <div className="flex-1 flex flex-col justify-center px-16 bg-white">
          ...
          <form className="max-w-md">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <Link to="/forgot-password" className="text-blue-500 text-sm no-underline hover:underline">
                Forget Password?
              </Link>
            </div>

            <button type="submit" className="w-full py-4 bg-blue-500 text-white border-none rounded-lg text-base font-semibold cursor-pointer transition-colors duration-300 mb-6 hover:bg-blue-600">
              Sign In
            </button>
          </form>
          ...
          <div className="text-center text-sm text-gray-600">
            Don't have an account? <Link to="/signup" className="text-blue-500 font-semibold no-underline hover:underline">Sign Up</Link>
          </div>
        </div>
