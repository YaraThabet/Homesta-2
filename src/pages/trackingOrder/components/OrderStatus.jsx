...
const OrderStatus = ({ status }) => {
  ...
  return (
    <section className="font-outfit">
      <div className="border border-gray-100 rounded-[30px] p-6 sm:p-10 mb-10 shadow-sm bg-white overflow-x-auto">
        <div className="min-w-[700px]">
          ...
          <div className="relative h-1 mb-4 flex items-center">
            <div className="absolute top-1/2 left-[10%] w-[80%] h-1 bg-gray-100 -translate-y-1/2 z-0 rounded-full" />
