      ...
      <div className="w-full h-[820] mx-5 my-15 ">
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6">
          {deals.map((item) => (
            <div
              key={item.id}
              className="group w-full h-auto p-4 border-zinc-500 rounded-2xl shadow-xl flex flex-col md:flex-row gap-6 md:gap-[50px] transition-all duration-300"
            >
              <div
                className="w-full md:w-[304px] h-[250px] md:h-[374px] rounded-3xl shadow-2xl overflow-hidden relative"
              >
                <div
                  className="w-full h-full bg-cover bg-center transition-transform duration-700 group-hover:scale-110"
                  style={{ backgroundImage: `url(${item.image})` }}
                />
                <div className="flex items-center justify-center w-[96px] h-[39px] rounded-full bg-[#205457] absolute top-4 left-4 px-4 py-2 shadow-md">
              ...
              <div className="flex flex-col w-full md:w-[225px] gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="font-outfit font-normal text-[16px] md:text-[18px]">
                    {item.price}{" "}
                    <span className="text-[#A4A7AE] line-through ml-2">{item.oldPrice}</span>
                  </p>
                </div>
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full md:w-[207px] h-[52px] rounded-3xl bg-[#205457] hover:scale-105 active:scale-95 transition-all"
                >
          ...
          {furnitureCards.map((item) => (
            <div
              key={item.id}
              className="group w-full h-auto p-4 border-zinc-500 rounded-2xl shadow-xl gap-[50px] flex justify-between transition-all duration-300"
            ...
            >
              <div className="flex flex-col w-[253px] h-[307px] gap-[24px]">
                ...
                <p className={`w-[253px] h-[106px] font-outfit font-medium text-[42px] ${item.bgColor === '#205457' ? 'text-white' : 'text-black'}`}>{item.title}</p>
                ...
                <div className="flex flex-row w-[204px] h-[24px] gap-[8px]">
                  <button
                    onClick={() => navigate('/shop')}
                    className="flex justify-center w-[207px] h-[52px] rounded-3xl p-x[16px] py-[8px] gap-[8px] bg-[#B19470] hover:scale-105 active:scale-95 transition-all"
                  >
              ...
              <div className="w-[230px] h-[327px] overflow-hidden">
                <img
                  src={item.image}
                  alt="chair"
